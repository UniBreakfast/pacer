...
const choiceModal = new Modal('resolveByHand.htm', {inDOMwhenHidden: false,
                            hideOnGlassClick: false, fillcb, top, left, width})

export function resolveByHand(msg, options, specialWidth) {
